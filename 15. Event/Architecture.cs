...
namespace _15._Event
{
    class Architecture
    {
        ...
        public class Polling
        {
            ...
            public class UI
            {
                public Player player;  // UI가 플레이어를 가지고 있음
        ...
        // HP, 스킬, 점프 같은 경우엔 어떤 사건이 발생했을 때 반영해주면 되니 이벤트라고 할 수 있음
        // 플레이어의 위치, 속도, 물리엔진 같은 실시간으로 바뀌는 것에 대한 경우엔 event보다 polling 방식이 맞음
        // polling은 유니티에서 update (프레임마다) 기능과 같음
        // 게임개발은 프레임단위라 Polling 방식이나 Event 방식을 쓰기 좋음
        // Calling 방식은 그냥 가장 직관적인 상황에서 사용하기 좋음?
